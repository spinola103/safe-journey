...
import '../../../core/providers/womens_mode_provider.dart';
...
class _HomeScreenState extends ConsumerState<HomeScreen> {
        ...
        CameraUpdate.newLatLngBounds(
          LatLngBounds(
            southwest: LatLng(
              ...
              fromLL.longitude < toLL.longitude
                  ? fromLL.longitude
                  : toLL.longitude,
            ),
            northeast: LatLng(
  ...
  Future<void> _searchRoutes() async {
    final womensMode = ref.read(womensModeProvider);
    ...
    List<JourneyPlan> plans = await RoutingService.fetchRoutes(
      ...
      womensMode: womensMode,
    );

    if (plans.isEmpty) {
      plans =
          DemoRoutes.routeDatabase['$origin|$destination'] ??
    ...
    if (mounted) {
      ...
      context.push(
        '/results',
        extra: {'plans': plans, 'womensMode': womensMode},
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    final _womensModeOn = ref.watch(womensModeProvider);
    return Scaffold(
                  ...
                  Positioned(
                    ...
                    child: Row(
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            ref.read(womensModeProvider.notifier).state =
                                !_womensModeOn;
                          },
              ...
              child: Column(
                ...
                children: [
                  ...
                  _SearchCard(
                    ...
                    loading: _searching,
                    onLocationChanged:
                        _updateMapMarkers, // <── triggers map update
                  ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: widget.womensModeOn
                        ? AppColors.teal
                        : AppColors.navy,
